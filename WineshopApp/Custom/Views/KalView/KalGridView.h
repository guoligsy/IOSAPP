...
//  id<getDateInSelectedTileViewDelegate> _selectedTileViewDelegate;
  KalLogic *logic;
...
//@property (nonatomic,assign) id<getDateInSelectedTileViewDelegate> selectedTileViewDelegate;
@property (nonatomic, readonly) BOOL transitioning;
@property (nonatomic, readonly) KalDate *selectedDate;
//add by Even zheng
//@property (nonatomic, readonly) KalTileView *selectedTile;
